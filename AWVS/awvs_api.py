...
tarurl = "https://114.115.162.170:13443"
apikey = "1986ad8c0a5b3df4d7028d5f3c06e936c3ae426b5f74944fab0731929013c656c"
...
if __name__ == '__main__':
    info = getscan()
    for i in info["scans"]:
        print(i["current_session"]["status"], i["scan_id"], i["target"]["address"], i["current_session"]["severity_counts"])

    # add scan target
    # print config('http://144.161.8.52/')
